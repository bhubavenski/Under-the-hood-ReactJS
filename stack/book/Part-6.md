...
### Alright, we’ve finished _Part 6_.
...
Nice. In fact, that’s all that happens here. So, we can take the essential value from _Part 6_ and use it for the final `mounting` scheme:
