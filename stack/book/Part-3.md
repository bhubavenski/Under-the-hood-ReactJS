...
### Alright, we’ve finished _Part 3_.
...
Nice. In fact, that’s all that happens here. So, we can take the essential value from _Part 3_ and use it for the final `mounting` scheme:
